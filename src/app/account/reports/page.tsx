  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10 dark:bg-slate-800">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-xl font-semibold text-slate-900 mt-4 mb-1 dark:text-slate-100">My scheduled reports</h1>
        <p className="text-sm text-slate-500 mb-6 dark:text-slate-400">Reports an administrator has scheduled to be sent to you.</p>
